        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "value": {"type": "string", "description": "Value: on/off for toggle, agent/loop/chat for set_mode, model name for switch_model, theme name for set_theme, or folder for open_email_reply"},
